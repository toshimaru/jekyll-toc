...
class TestVariousTocHtml < Minitest::Test
  ...
  def test_german_toc
    ...
    expected = <<~HTML.chomp
      <ul id="toc" class="section-nav">
      <li class="toc-entry toc-h1"><a href="#ss-vs-%C3%9F">ss vs. ß</a>
      <ul>
      <li class="toc-entry toc-h2"><a href="#german-text">German Text</a>
      <ul>
      <li class="toc-entry toc-h3"><a href="#%C3%A4%C3%B6%C3%BC">ÄÖÜ</a></li>
      </ul>
      </li>
      </ul>
      </li>
    ...
    assert_equal(expected, parser.build_toc)
    html_with_anchors = parser.inject_anchors_into_html
    assert_match(%r{<a class="anchor" href="#ss-vs-%C3%9F" aria-hidden="true"><span.*span></a>ss vs. ß}, html_with_anchors)
    assert_match(%r{<a class="anchor" href="#german-text" aria-hidden="true"><span.*span></a>German Text}, html_with_anchors)
    assert_match(%r{<a class="anchor" href="#%C3%A4%C3%B6%C3%BC" aria-hidden="true"><span.*span></a>ÄÖÜ}, html_with_anchors)
  end

  def test_same_anchor_toc
    parser = Jekyll::TableOfContents::Parser.new(<<~HTML)
      <h1>foo bar</h1>
      <h2>Foo Bar</h2>
      <h3>Foo-Bar</h3>
    ...
    expected = <<~HTML.chomp
      <ul id="toc" class="section-nav">
      <li class="toc-entry toc-h1"><a href="#foo-bar">foo bar</a>
      <ul>
      <li class="toc-entry toc-h2"><a href="#foo-bar-1">Foo Bar</a>
      <ul>
      <li class="toc-entry toc-h3"><a href="#foo-bar-2">Foo-Bar</a>
      <ul>
      <li class="toc-entry toc-h4"><a href="#foo-bar-3">.Foo-.Bar.</a></li>
      </ul>
      </li>
      </ul>
      </li>
    ...
    assert_equal(expected, parser.build_toc)
    html_with_anchors = parser.inject_anchors_into_html
    assert_match(%r{<a class="anchor" href="#foo-bar" aria-hidden="true"><span.*span></a>foo bar}, html_with_anchors)
    assert_match(%r{<a class="anchor" href="#foo-bar-1" aria-hidden="true"><span.*span></a>Foo Bar}, html_with_anchors)
    assert_match(%r{<a class="anchor" href="#foo-bar-2" aria-hidden="true"><span.*span></a>Foo-Bar}, html_with_anchors)
    assert_match(%r{<a class="anchor" href="#foo-bar-3" aria-hidden="true"><span.*span></a>.Foo-.Bar.}, html_with_anchors)
  end
